            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                ...
                <div class="module-card rounded-2xl shadow-lg p-8 card-hover cursor-pointer border border-white/50" onclick="window.location.href='/patient'">
                    <div class="text-center">
                        ...
                        <button class="bg-gradient-to-r from-green-600 to-green-700 text-white px-8 py-3 rounded-full hover:shadow-lg transform hover:scale-105 transition-all font-semibold">
                            Acessar
                        </button>
                    </div>
                </div>
                ...
                <div class="module-card rounded-2xl shadow-lg p-8 card-hover cursor-pointer border border-white/50" onclick="window.location.href='/doctor'">
                    <div class="text-center">
                        ...
                        <button class="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-8 py-3 rounded-full hover:shadow-lg transform hover:scale-105 transition-all font-semibold">
                            Acessar
                        </button>
                    </div>
                </div>
                ...
                <div class="module-card rounded-2xl shadow-lg p-8 card-hover cursor-pointer border border-white/50" onclick="window.location.href='/navigator'">
                    <div class="text-center">
                        ...
                        <button class="bg-gradient-to-r from-teal-600 to-teal-700 text-white px-8 py-3 rounded-full hover:shadow-lg transform hover:scale-105 transition-all font-semibold">
                            Acessar
                        </button>
                    </div>
                </div>
                ...
                <div class="module-card rounded-2xl shadow-lg p-8 card-hover cursor-pointer border border-white/50" onclick="window.location.href='/financial'">
                    <div class="text-center">
                        ...
                        <button class="bg-gradient-to-r from-lime-600 to-lime-700 text-white px-8 py-3 rounded-full hover:shadow-lg transform hover:scale-105 transition-all font-semibold">
                            Acessar
                        </button>
                    </div>
                </div>
                ...
                <div class="module-card rounded-2xl shadow-lg p-8 card-hover cursor-pointer border border-white/50" onclick="window.location.href='/wellness'">
                    <div class="text-center">
                        ...
                        <button class="bg-gradient-to-r from-cyan-600 to-cyan-700 text-white px-8 py-3 rounded-full hover:shadow-lg transform hover:scale-105 transition-all font-semibold">
                            Acessar
                        </button>
                    </div>
                </div>
                ...
                <div class="module-card rounded-2xl shadow-lg p-8 card-hover cursor-pointer border border-white/50" onclick="window.location.href='/research'">
                    <div class="text-center">
                        ...
                        <button class="bg-gradient-to-r from-green-700 to-green-800 text-white px-8 py-3 rounded-full hover:shadow-lg transform hover:scale-105 transition-all font-semibold">
                            Acessar
                        </button>
                    </div>
                </div>
