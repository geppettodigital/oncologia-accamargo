...
<body class="bg-gradient-to-br from-teal-50 to-blue-50 min-h-screen">
            ...
            <div id="tab-agendar" class="tab-content hidden">
                ...
                <div class="bg-gray-50 p-6 rounded-xl">
                    ...
                    <div class="grid grid-cols-7 gap-1">
                        ...
                        ${Array.from({length:31},(i,o)=>{const r=o+1,d=r===25||r===28||r===30;return`
                                <div class="text-center p-2 ${d?"bg-purple-100 rounded-lg":"hover:bg-gray-100"} cursor-pointer">
                                    <span class="${d?"font-bold text-purple-600":"text-gray-700"}">${r}</span>
                                    ${d?'<div class="w-1 h-1 bg-purple-600 rounded-full mx-auto mt-1"></div>':""}
                                </div>
                            `}).join("")}
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                        <div class="bg-white p-3 rounded-lg">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-green-600 font-bold flex items-center">
                                    <i class="fas fa-arrow-down mr-1"></i>${s.tendencia}
                                </span>
                            </div>
                        ...
                        <div class="bg-white p-3 rounded-lg">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-orange-600 font-bold">${s.pontoCritico}</span>
                            </div>
                        ...
                        <div class="bg-white p-3 rounded-lg">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-blue-600 font-bold">${s.previsao}</span>
                            </div>
    ...
    `):e.html(`
        ...
        `)});var it=Object.freeze,Za=Object.defineProperty,Xa=(e,t)=>it(Za(e,"raw",{value:it(t||e.slice())})),ot;const es=e=>e.html(H(ot||(ot=Xa([`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
        <meta charset="UTF-8">
  ...
  `])),me(V("patient"))));var rt=Object.freeze,ts=Object.defineProperty,as=(e,t)=>rt(ts(e,"raw",{value:rt(t||e.slice())})),nt;const ss=e=>e.html(H(nt||(nt=as([`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
        <meta charset="UTF-8">
  ...
  `]))));var lt=Object.freeze,is=Object.defineProperty,os=(e,t)=>lt(is(e,"raw",{value:lt(e.slice())})),dt;const rs=e=>e.html(H(dt||(dt=os([`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
        <meta charset="UTF-8">
  ...
  `]))));var ct=Object.freeze,ns=Object.defineProperty,ls=(e,t)=>ct(ns(e,"raw",{value:ct(e.slice())})),pt;const ds=e=>e.html(H(pt||(pt=ls([`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
        <meta charset="UTF-8">
  ...
  `]))));var mt=Object.freeze,cs=Object.defineProperty,ps=(e,t)=>mt(cs(e,"raw",{value:mt(e.slice())})),gt;const ms=e=>e.html(H(gt||(gt=ps([`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
        <meta charset="UTF-8">
  ...
  `]))));var ut=Object.freeze,gs=Object.defineProperty,us=(e,t)=>ut(gs(e,"raw",{value:ut(e.slice())})),xt;const xs=e=>e.html(H(xt||(xt=us([`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
        <meta charset="UTF-8">
  ...
  `]))));var ft=Object.freeze,fs=Object.defineProperty,bs=(e,t)=>ft(fs(e,"raw",{value:ft(e.slice())})),bt;const vs=e=>e.html(H(bt||(bt=bs([`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
        <meta charset="UTF-8">
  ...
  `]))));var vt=Object.freeze,hs=Object.defineProperty,ys=(e,t)=>vt(hs(e,"raw",{value:vt(e.slice())})),ht;const ws=e=>e.html(H(ht||(ht=ys([`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
        <meta charset="UTF-8">
  ...
  `])),me(V("admin"))));new S;const Cs=e=>e.html(`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
        <meta charset="UTF-8">
  ...
  `);var yt=Object.freeze,As=Object.defineProperty,Ps=(e,t)=>yt(As(e,"raw",{value:yt(e.slice())})),wt;const b=new S;b.use("/api/*",Ba());b.use("/static/*",Zt({root:"./public"}));b.use("/*.html",Zt({root:"./public"}));b.route("/api/patient",Re);b.route("/api/doctor",Me);b.route("/api/navigator",De);b.route("/api/financial",Le);b.route("/api/wellness",Ne);b.route("/api/research",he);b.route("/api/admin",ie);b.route("/api/ai",oe);b.route("/api/portal",K);b.route("/",Xt);b.route("/",ea);b.route("/",ta);b.get("/patient-view/:id",e=>{const t=e.req.param("id");return e.redirect(`/patient-view-integrated/${t}`,301)});b.get("/portal/patient",es);b.get("/portal/doctor",ss);b.get("/portal/navigator",rs);b.get("/portal/financial",ds);b.get("/portal/wellness",ms);b.get("/portal/research",xs);b.get("/portal/admin-master",vs);b.get("/admin-master",ws);b.get("/test-integration",Cs);b.get("/",e=>e.html(H(wt||(wt=Ps([`
    <!DOCTYPE html>
    <html lang="pt-BR">
    <head>
        <meta charset="UTF-8">
...
</html>`));const Ct=new S,ks=Object.assign({"/src/index.tsx":b});let aa=!1;for(const[,e]of Object.entries(ks))e&&(Ct.all("*",t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),Ct.notFound(t=>{let a;try{a=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,a)}),aa=!0);if(!aa)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");export{Ct as default};
